...
% Not deducting any points here, but this seems quite high! I have a hard time believing the result.
...
% KN: It'd be great to show the work here. I don't see anything in the repository.
...
% KN
%
% Tip: You need to set the size with includegraphics.
\begin{figure}
    \centering
